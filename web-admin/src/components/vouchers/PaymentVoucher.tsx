...
export const PaymentVoucher: React.FC<VoucherProps> = ({ data }) => {
        ...
        >
            ...
            <div className="flex justify-between items-start mb-4 relative z-10">
                ...
                <div className="w-[40%] text-center">
                    <p className="font-bold text-[13px]">Mẫu số 02 - TT</p>
            ...
            <div className="text-center mb-6 relative z-10">
                <h1 className="text-3xl font-bold uppercase mb-1">Phiếu Chi</h1>
            ...
            <div className="space-y-2 mb-6 text-[14px] relative z-10">
                <div className="flex items-end">
                    <span className="whitespace-nowrap min-w-[160px]">Họ và tên người nhận tiền:</span>
                ...
                <div className="flex items-end">
                    <span className="whitespace-nowrap min-w-[65px]">Lý do chi:</span>
                    <span className="border-b border-dotted border-black flex-grow ml-1 pl-2">
                        {data?.reason}
                    </span>
                </div>
            ...
            <div className="flex justify-end mb-2 mr-4 relative z-10">
                <p className="italic text-center w-auto">
                    Ngày {day} tháng {month} năm {year}
                </p>
            </div>
            ...
            {/* Signatures */}
            <div className="grid grid-cols-4 gap-2 text-center mt-4 mb-24 text-[13px] relative z-10">
                <div>
                ...
                <div>
                    ...
                    <p className="italic text-[11px]">(Ký, họ tên)</p>
                    <div className="h-20"></div>
                    <p className="font-bold mt-2">{data?.receiverName}</p>
                </div>
            </div>
